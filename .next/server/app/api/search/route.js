"use strict";(()=>{var e={};e.id=280,e.ids=[280],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3131:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>g,patchFetch:()=>f,requestAsyncStorage:()=>p,routeModule:()=>u,serverHooks:()=>h,staticGenerationAsyncStorage:()=>d});var r={};a.r(r),a.d(r,{GET:()=>l});var n=a(9303),s=a(8716),c=a(670),o=a(7070),i=a(3829);async function l(e){try{let{searchParams:t}=new URL(e.url),a=t.get("q")||"",r=t.get("collection")?parseInt(t.get("collection")):void 0,n=parseInt(t.get("limit")||"30");if(!a.trim())return o.NextResponse.json({results:{arabic:[],english:[]},count:0});let s=await i.Ox.search(a,r,n);return o.NextResponse.json({results:s,count:s.total})}catch(e){return o.NextResponse.json({error:e.message},{status:500})}}let u=new n.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/search/route",pathname:"/api/search",filename:"route",bundlePath:"app/api/search/route"},resolvedPagePath:"/public/Projects/Hadith/src/app/api/search/route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:p,staticGenerationAsyncStorage:d,serverHooks:h}=u,g="/api/search/route";function f(){return(0,c.patchFetch)({serverHooks:h,staticGenerationAsyncStorage:d})}},3829:(e,t,a)=>{a.d(t,{Ox:()=>d});let r=require("hadith");var n=a.n(r);let s=null,c=!1,o=null;async function i(){return s||(c||(c=!0,o=(async()=>{try{let e=new(n());await e.connect(),s=e,console.log("✅ Hadith DB connected")}catch(e){throw console.error("❌ DB connection failed:",e),e}finally{c=!1}})()),await o),s}async function l(e){let t=(await i()).db;if(!t)return null;try{let a=t.prepare(`
      SELECT 
        c0 as arabic_urn,
        c1 as urn,
        c2 as collection_id,
    ...
    FROM hadith_content
    WHERE c7 LIKE ?
  `,o=[s];t&&(c+=" AND c1 = ?",o.push(t)),c+=" ORDER BY c1, c4 LIMIT ? OFFSET ?",o.push(a+1,r);let l=n.prepare(c);l.bind(o);let u=[];for(;l.step();)u.push(l.getAsObject());return l.free(),u.slice(0,a)}async function p(e,t,a=30,r=0){let n=(await i()).db;if(!n)return[];let s=`%${e.replace(/'/g,"''")}%`,c=`
    SELECT 
