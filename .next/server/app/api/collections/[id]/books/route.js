"use strict";(()=>{var e={};e.id=667,e.ids=[667],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},2923:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>f,patchFetch:()=>g,requestAsyncStorage:()=>d,routeModule:()=>u,serverHooks:()=>h,staticGenerationAsyncStorage:()=>p});var r={};a.r(r),a.d(r,{GET:()=>l});var n=a(9303),s=a(8716),c=a(670),o=a(7070),i=a(3829);async function l(e,{params:t}){try{let e=await i.Ox.getBooks(parseInt(t.id));return o.NextResponse.json(e)}catch(e){return o.NextResponse.json({error:e.message},{status:500})}}let u=new n.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/collections/[id]/books/route",pathname:"/api/collections/[id]/books",filename:"route",bundlePath:"app/api/collections/[id]/books/route"},resolvedPagePath:"/public/Projects/Hadith/src/app/api/collections/[id]/books/route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:d,staticGenerationAsyncStorage:p,serverHooks:h}=u,f="/api/collections/[id]/books/route";function g(){return(0,c.patchFetch)({serverHooks:h,staticGenerationAsyncStorage:p})}},3829:(e,t,a)=>{a.d(t,{Ox:()=>p});let r=require("hadith");var n=a.n(r);let s=null,c=!1,o=null;async function i(){return s||(c||(c=!0,o=(async()=>{try{let e=new(n());await e.connect(),s=e,console.log("✅ Hadith DB connected")}catch(e){throw console.error("❌ DB connection failed:",e),e}finally{c=!1}})()),await o),s}async function l(e){let t=(await i()).db;if(!t)return null;try{let a=t.prepare(`
      SELECT 
        c0 as arabic_urn,
        c1 as urn,
        c2 as collection_id,
